class Scrollbar {
    ...
    constructor (data, canvas, scrollCanvas, options) {
        ...
        body.addEventListener('mousemove', e => this.onMouseMove(e), true)
        body.addEventListener('mouseup', e => this.onMouseUp(e), true)
        body.addEventListener('mouseenter', e => this.onMouseEnter(e), true)
